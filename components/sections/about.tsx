        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-8 text-lg md:text-xl text-muted-foreground leading-relaxed">
            <p className="text-justify">
              With extensive experience delivering <span className="text-foreground font-semibold">frontend solutions</span> for clients worldwide, I specialize in transforming design files into production-ready code. I combine strong <span className="text-foreground font-semibold">frontend engineering fundamentals</span> with practical <span className="text-foreground font-semibold">UI/UX understanding</span> to build <span className="text-foreground font-semibold">responsive, pixel-perfect interfaces</span>. Every project starts with a deep understanding of your design vision, which I translate into clean, maintainable, and <span className="text-foreground font-semibold">performance-optimized frontend code</span>.
            </p>
